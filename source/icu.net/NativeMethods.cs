	...
	internal static class NativeMethods
	{
		...
		private static IntPtr GetIcuLibHandle(string basename, int icuVersion)
		{
			...
			if (IsWindows)
			{
				...
				var testPath = @"D:\git\conniey\sillsdev\icu-dotnet3\source\icu.net.netstandard.testsrunner\bin\Debug\netcoreapp1.0\lib\x64\icuuc56.dll";
				handle = LoadLibraryEx(libPath, IntPtr.Zero, LoadLibraryFlags.LOAD_LIBRARY_SEARCH_DLL_LOAD_DIR | LoadLibraryFlags.LOAD_LIBRARY_SEARCH_DEFAULT_DIRS);
				var lastError = Marshal.GetLastWin32Error();
				var handle2 = LoadLibraryEx(testPath, IntPtr.Zero, LoadLibraryFlags.LOAD_LIBRARY_SEARCH_DLL_LOAD_DIR | LoadLibraryFlags.LOAD_LIBRARY_SEARCH_DEFAULT_DIRS);
